...
namespace tourism
{
    public partial class order : System.Web.UI.Page
    {
        ...
        public void fillgrid()
        {
            ...
            adp = new SqlDataAdapter("select bookingId,u.username,bookDate,payment,payment_status from booking b,users u where b.userId=" + x+" and payment_status="+1+" and b.userId=u.userId", con);
            ds = new DataSet();
            adp.Fill(ds);
